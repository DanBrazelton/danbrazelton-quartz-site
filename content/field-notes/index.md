...
I keep one notebook, not two. The temptation, when you have a professional self and a private one, is to wall them off — operations over here, the kitchen and the radio over there, never to be seen in the same sentence. I've come to think that wall is dishonest, and worse, that it makes the writing dull. The same mind is doing all of it. The essay about taking cost out of a plant and the one about why a stock has to be built slowly are, if I've done them right, the same essay.
