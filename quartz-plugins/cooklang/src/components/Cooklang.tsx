...
// Client-side script. Runs on every (SPA) navigation. Finds raw ```cooklang
// code blocks on the page and replaces them with an interactive ingredients +
// steps widget that scales with a servings slider. Also hides any raw
// ```dataviewjs blocks (Obsidian-only directives that mean nothing on the web).
//
// String.raw keeps every backslash in the regexes intact through bundling.
...
const Cooklang: QuartzComponent = () => null
